...
/**
 * Convert raw permissions to a simpler { uri: { verb: permission, ... } format.
 */
function _simplePermissions(permissions) {

  var simplePermissions = {};

  __.sortBy(Object.keys(permissions), 'length').forEach(function(permissionUri) {
    simplePermissions[permissionUri] = permissions[permissionUri];
  });
...
function generatePermissionEntries() {
  ...
  var simplePermissions = _simplePermissions(_permissions);
